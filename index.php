...
<div class="container">
    <div class="sixteen columns">
        ...
        <ul id="popular-categories">
            <li ><a href="#" class="hvr-bob"><i class="fa fa-line-chart"></i> Accounting / Finance</a></li>
            <li><a href="#"  class="hvr-bob"><i class="fa fa-wrench"></i> Automotive Jobs</a></li>
            <li><a href="#"  class="hvr-bob"><i class="fa fa-building-o"></i> Construction / Facilities</a></li>
            <li><a href="#"  class="hvr-bob"><i class="fa fa-graduation-cap"></i> Education Training</a></li>
            <li><a href="#" class="hvr-bob"><i class="fa fa-medkit"></i> Healthcare</a></li>
            <li><a href="#"  class="hvr-bob"><i class="fa fa-cutlery"></i> Restaurant / Food Service</a></li>
            <li><a href="#"  class="hvr-bob"><i class="fa fa-globe"></i> Transportation / Logistics</a></li>
            <li><a href="#" class="hvr-bob"><i class="fa fa-laptop"></i> Telecommunications</a></li>
        </ul>
...
<div id="clients">
    ...
    <div class="container">
        ...
        <div class="sixteen columns">
            ...
            <!-- Navigation / Left -->
            <div class="one carousel column"><div id="showbiz_left_2" class="sb-navigation-left-2 notclickable"><i class="fa fa-angle-left"></i></div></div>

            <!-- ShowBiz Carousel -->
            <div id="our-clients" class="showbiz-container fourteen carousel columns">

                <!-- Portfolio Entries -->
                <div class="showbiz our-clients" data-left="#showbiz_left_2" data-right="#showbiz_right_2" id="sbiz5365">
                    <div class="overflowholder" style="height: 100px; overflow: hidden;">

                        <ul style="width: 1491px; left: 0px; height: 100px; overflow: hidden;">
                            <!-- Item -->
                            <li style="width: 190px;"><img src="images/logo-01.png" alt=""></li>
                            <li style="width: 190px;"><img src="images/logo-02.png" alt=""></li>
                            <li style="width: 190px;"><img src="images/logo-03.png" alt=""></li>
                            <li style="width: 190px;"><img src="images/logo-04.png" alt=""></li>
                            <li style="width: 190px;"><img src="images/logo-05.png" alt=""></li>
                            <li style="width: 190px;"><img src="images/logo-06.png" alt=""></li>
                            <li style="width: 190px;"><img src="images/logo-07.png" alt=""></li>
                        </ul>
                        <div class="clearfix"></div>
...
<!-- Mirrored from vasterad.com/themes/workscout/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jun 2016 16:47:11 GMT -->
</html>